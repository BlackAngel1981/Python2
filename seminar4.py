...
spisok_1 = set(map(int, input(f'input {a} numbers separated by spaces: ').split()))
spisok_2 = set(map(int, input(f'input {b} numbers separated by spaces: ').split()))
a = len(spisok_1)
b = len(spisok_2)
spisok_3 = spisok_1.intersection(spisok_2)
print(sorted(spisok_3))
...
N = int(input('Input nymbers bushes: '))
spisok = list(map(int, input(f'Input {N} numbers separated by spaces: ').split()))
